...
**Репозиторий**: https://github.com/Roflmax/topik-app

**Проект**: TOPIK Practice App — веб/мобильное приложение для подготовки к экзамену TOPIK (корейский язык)

#### Оценки по критериям

| Критерий | Оценка | Комментарий |
|----------|:------:|-------------|
| **Работоспособность MVP** | **5** | Full-stack: Expo + Supabase. 11 полных экзаменов, 1914 вопросов, iOS/Android/Web. Production на topiklab.com |
| **Качество эволюции** | **4** | **30 коммитов**, Git Flow (main/dev/feature), GitHub Actions CI/CD |
| **Тесты** | **2** | **Нет тестов!** Критический минус. Нет BDD |
| **Документация** | **5** | README (295 стр), CLAUDE.md, back/docs/ (DATABASE.md, PRODUCT.md, SCREENS.md) |
| **Vibe Coding подход** | **3** | CLAUDE.md есть но краткий, MCP конфиг, нет multi-agent workflow, нет BDD |
...
**Масштаб контента:**
- 11 полных экзаменов (#35, 36, 37, 41, 47, 52, 60, 64, 83, 91, 96)
- 55 секций (вариантов)
- 1914 вопросов
- 845 медиа-файлов (аудио + изображения)
...
**Фичи:**
- Симулятор полного экзамена
- Практика по 38 типам вопросов
- Таймер с цветовой индикацией
- Autosave ответов
- Аудио-плеер для Listening
- Система оценивания TOPIK (1-6 급)
- RLS (Row Level Security) политики

**Production:**
- Frontend: https://web.topiklab.com
- Backend: https://back.topiklab.com:8443
- GitHub Actions автодеплой

**Что критически снизило оценку:**
- **Нет тестов** — ни одного test файла
- **Нет BDD** — спецификация только в документации
- **CLAUDE.md** — reference документ, не AI workflow

**Рекомендации:**
1. Добавить тесты (хотя бы unit для scoring, validation)
2. Добавить BDD .feature файлы для критических user flows
3. Расширить CLAUDE.md с AI workflow и agents
