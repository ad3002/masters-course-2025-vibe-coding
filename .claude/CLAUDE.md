...
**Прочитанные лекции (каждая среда):**
1. **17 сентября 2025** — Введение в vibe coding (Claude Sonnet 4)
2. **24 сентября 2025** — Подходы и инструменты (Claude Sonnet 4)
3. **1 октября 2025** — Спецификации и агенты (Claude Sonnet 4.5)
4. **8 октября 2025** — Автономная AI-разработка в действии (Claude Sonnet 4.5)

**Запланированные лекции:**
5. **15 октября 2025** — TBD
6. **22 октября 2025** — TBD
...
**Модели AI-соведущего:**
- Лекции 1-2: Claude Sonnet 4 (сентябрь 2025)
- Лекции 3+: Claude Sonnet 4.5 (октябрь 2025)
